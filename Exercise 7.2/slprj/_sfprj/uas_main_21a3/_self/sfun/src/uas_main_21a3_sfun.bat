...
set COMPILER=C:\ProgramData\MATLAB\SupportPackages\R2023a\3P.instrset\mingw_w64.instrset\bin\gcc
                ...
                set LINKFLAGS=-m64 -Wl,--no-undefined -shared -static -L"D:\MATLAB\extern\lib\win64\mingw64" -llibmx -llibmex -llibmat -lm -llibmwlapack -llibmwblas -llibMatlabDataArray -llibMatlabEngine -Wl,"D:\MATLAB/extern/lib/win64/mingw64/mexFunction.def"
                set LINKDEBUGFLAGS=-g
                set NAME_OUTPUT= -o "%OUTDIR%%MEX_NAME%%MEX_EXT%"
set PATH=C:\ProgramData\MATLAB\SupportPackages\R2023a\3P.instrset\mingw_w64.instrset\bin;D:\MATLAB\extern\include\win64;D:\MATLAB\extern\include;D:\MATLAB\simulink\include;D:\MATLAB\lib\win64;%MATLAB_BIN%;%PATH%
...
gmake SHELL="cmd" -f uas_main_21a3_sfun.gmk
